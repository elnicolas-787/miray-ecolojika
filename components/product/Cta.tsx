...
const Cta = () => {
  return (
    <section className="py-xl px-margin-desktop">
      <div className="max-w-[1440px] mx-auto bg-primary rounded-[2rem] p-lg md:p-xl relative overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto">
          <h2 className="text-4xl text-bold text-on-primary mb-md">
            Prêt à régénérer vos terres ?
          </h2>
          <p className="text-lg text-on-primary opacity-80 mb-lg">
