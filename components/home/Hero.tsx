      ...
      <div className="mx-auto max-sm:px-6 max-xl:px-5 max-w-7xl relative z-10 w-full grid grid-cols-1 md:grid-cols-2 gap-gutter">
        <div className="max-w-4xl space-y-8 md:space-y-7 lg:space-y-9">
          ...
          <div className="flex max-md:justify-center flex-wrap gap-2 lg:gap-4">
            <a
              className="max-[448px]:w-full text-center bg-secondary-fixed text-on-secondary-fixed py-2.5 px-6 sm:py-3 rounded max-sm:text-sm text-bold transition-all duration-300 hover:scale-105 shadow-xl shadow-black/10"
              href="#solutions"
            >
              Découvrir nos solutions
            </a>
            <a
              className="max-[448px]:w-full text-center border-2 border-primary-fixed text-primary-fixed py-2.5 px-6 sm:py-3 rounded max-sm:text-sm text-bold transition-all duration-300 hover:scale-105 hover:bg-primary-fixed/10"
              href="#contact"
            >
              Nous soutenir
            </a>
